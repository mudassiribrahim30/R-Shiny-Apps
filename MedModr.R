...
"))
  ...
  # App title with HTML styling for display only - won't appear in exports
  tags$div(
    style = "margin-bottom: 20px;",
    h1(
      app_name, 
      style = "font-family: 'Poppins', sans-serif; font-weight: 700; font-size: 2.5rem; background: linear-gradient(135deg, #3498db 0%, #9b59b6 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; text-align: center; margin: 1rem 0 0 0; padding: 1rem;",
      tags$small(
        paste0("v", app_version, " (", release_date, ")"), 
        style = "font-size: 14px; color: #7f8c8d; font-family: 'Roboto', sans-serif;"
      )
    )
  ),
